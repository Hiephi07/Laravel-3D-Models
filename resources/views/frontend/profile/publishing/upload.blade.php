    ...
    <div class="row">
        ...
        <div class="col-md-2 sidebar text-white p-0" style="height: auto; background-color: #293541;">
            ...
            <div class="list-group">
                ...
                <a href="{{route('profile.upload')}}" class="border border-0 py-3 text-white list-group-item list-group-item-action active" aria-current="true" style="font-size: 0.75rem;">
        ...
        <main class="col-md-10 mb-5 px-md-4">
            <form action="" method="" class="mb-3 mt-3"></form>
            <div class="row border border-1">
                <div class="col-md-8 p-3">
                    ...
                    <div class="mb-3">
                        <label for="formFile2" class="form-label">Thumbnail (1 max Minimum size: 1200x1200px.)</label>
                        <input class="form-control" type="file" id="formFile2">
                    </div>
                    <div class="mb-3">
                        <label for="formFile3" class="form-label">Preview (12 max Minimum size: 1920x1080px.)</label>
            ...
            <div class="row border border-1 mt-3 py-3 px-2">
                ...
                <div class="mb-3 ">
                    ...
                    <div class="d-flex justify-content-between">
                        <input type="email" class="form-control rounded-start rounded-0" id="exampleFormControlInput1">
                        <select class="form-select rounded-end rounded-0" aria-label="Default select example"
                            style="width: auto;">
                            <option>3D model</option>
                            <option value="1">3D print model</option>
                        </select>
                    </div>
                </div>
            ...
            <div class="row border border-1 mt-3 py-3 px-2">
                ...
                <div class="mb-5 ">
                    <div class="row">
                        ...
                        <div class="col-6">
                            <label for="exampleFormControlInput1" class="form-label">Subcategory <span
                                    class="text-danger">*</span></label>
                            <select class="form-select" aria-label="Default select example">
                                <option class="text-secondary" selected>Choose subcategory</option>
                                <option>3D model</option>
                                <option value="1">3D print model</option>
                            </select>
                        </div>
            ...
            <div class="row border border-1 mt-3 py-3 px-2">
                ...
                <div class="input-group mb-3 d-flex justify-content-end">
                    <button class="btn btn-outline-secondary me-3" type="button">Delete draft</button>
                    <button class="btn btn-outline-secondary me-3" type="button">Preview</button>
